...
print("=" * 70)
print("LOAD (true LI-Small, full graph)")
...
print()
print("This is TRUE LI-Small (6,924,049 rows, IBM Kaggle archive) -- no")
print("provenance caveat. Compare phase3_transfer_li.py (the 50% mirror):")
print("AUROC 0.6901 there vs here -- the difference is what subsampling the")
print("graph in half cost, and it was previously confounded with transfer loss.")
